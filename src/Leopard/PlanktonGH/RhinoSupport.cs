...
namespace PlanktonGh
{
    ...
    public static class RhinoSupport
    {
        ...
        /// <summary>
        ///  Creates a Rhino Vector3d from a Plankton vector. ///// Add by Gene ------------------------------------------
        /// </summary>
        /// <param name="vector"></param>
        /// <returns>A Vector3d with the same XYZ components as the vector.</returns>
        public static Vector3d ToVector3d(this PlanktonXYZ vector)
        {
